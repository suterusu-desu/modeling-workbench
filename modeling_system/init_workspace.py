...
def initialize(path, character):
    ...
    files={'modeling-workspace.json':json.dumps(binding,indent=2),
        'PROJECT.md':(source/'plugin/skills/modeling-workbench/references/current-page.md').read_text(encoding='utf-8'),
