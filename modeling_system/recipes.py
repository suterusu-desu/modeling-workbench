...
OUTPUTS = {
    'inspect_graph_path': {'analysis','status','summary','native_ready','target_admission','reads'},
    'inspect_surface_correspondence': {'analysis','status','summary','next_actions','native_ready','target_admission','reads'},
